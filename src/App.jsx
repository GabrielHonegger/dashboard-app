...
import { Calendar, ColorPicker, ColorMapping, Customers, Ecommerce, Editor,
Employees, Kanban, Orders, Area, Bar, Financial, Line, Pie, Pyramid, Stacked } from './pages'
import './App.css'
    ...
    <BrowserRouter>
      <div className='flex relative dark:bg-main-dark-bg'>
        ...
        <div className={
          ...
          'dark:bg-main-bg bg-main-bg w-full flex-2'
        }>
